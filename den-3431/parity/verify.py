...
assert p['encryption']['clientModeMetadataVerified'] and p['encryption']['serverModeMetadataVerified']
assert p['encryption']['invalidModeRejected'] and p['encryption']['rawKeyExcluded']
...
assert p['isolation']['crossPrefixReadRejected']
